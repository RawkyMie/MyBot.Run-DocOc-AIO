...
Local $sKingStatus, $sQueenStatus, $sWardenStatus
		...
		;GET HERO STATUS King
			$sKingStatus = ArmyHeroStatus(0)
			$sQueenStatus = ArmyHeroStatus(1)
			$sWardenStatus = ArmyHeroStatus(2)
;			Setlog("Herostatus : King : " & $sKingStatus)
;			Setlog("Herostatus : Queen : " & $sQueenStatus)
;			Setlog("Herostatus : Warden : " & "'"&$sWardenStatus&"'")
		; Update Colors for King
			Switch $sKingStatus
				Case "heal" ; Yellow
		...
		;Update Colors for Queen
			...
			EndSwitch
		;Udate Colors for Warden
			Switch $sWardenStatus
				Case "heal" ; Yellow
