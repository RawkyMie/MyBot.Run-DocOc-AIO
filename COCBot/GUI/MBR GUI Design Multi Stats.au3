...
Local $x = -5, $y = 7
	...
	$g_grpVillageSW[1] 			= GUICtrlCreateGroup("Account 1", $x + 16, $y + 18, 209, 97, BitOR($GUI_SS_DEFAULT_GROUP,$BS_FLAT))
		...
		$g_icnPopOutSW[1] 		= GUICtrlCreateIcon($pIconLib, $eIcnMove, $x + 208,  $y + 27, 12, 12)
	...
	$g_grpVillageSW[2] 			= GUICtrlCreateGroup("Account 2", $x + 16, $y + 120, 209, 97, BitOR($GUI_SS_DEFAULT_GROUP,$BS_FLAT))
		...
		$g_icnPopOutSW[2] 		= GUICtrlCreateIcon($pIconLib, $eIcnMove, $x + 208,  $y + 129, 12, 12)
	...
	$g_grpVillageSW[3] 			= GUICtrlCreateGroup("Account 3", $x + 16, $y + 222, 209, 97, BitOR($GUI_SS_DEFAULT_GROUP,$BS_FLAT))
		...
		$g_icnPopOutSW[3] 		= GUICtrlCreateIcon($pIconLib, $eIcnMove, $x + 208,  $y + 231, 12, 12)
	...
	$g_grpVillageSW[4] 			= GUICtrlCreateGroup("Account 4", $x + 16, $y + 324, 209, 97, BitOR($GUI_SS_DEFAULT_GROUP,$BS_FLAT))
		...
		$g_icnPopOutSW[4] 		= GUICtrlCreateIcon($pIconLib, $eIcnMove, $x + 208,  $y + 333, 12, 12)
	...
	$g_grpVillageSW[5] 			= GUICtrlCreateGroup("Account 5", $x + 232, $y + 18, 209, 97, BitOR($GUI_SS_DEFAULT_GROUP,$BS_FLAT))
		...
		$g_icnPopOutSW[5] 		= GUICtrlCreateIcon($pIconLib, $eIcnMove, $x + 424,  $y + 27, 12, 12) 
	...
	$g_grpVillageSW[6] 			= GUICtrlCreateGroup("Account 6", $x + 232, $y + 120, 209, 97, BitOR($GUI_SS_DEFAULT_GROUP,$BS_FLAT))
		...
		$g_icnPopOutSW[6] 		= GUICtrlCreateIcon($pIconLib, $eIcnMove, $x + 424,  $y + 129, 12, 12)
	...
	$g_grpVillageSW[7] 			= GUICtrlCreateGroup("Account 7", $x + 232, $y + 222, 209, 97, BitOR($GUI_SS_DEFAULT_GROUP,$BS_FLAT))
		...
		$g_icnPopOutSW[7] 		= GUICtrlCreateIcon($pIconLib, $eIcnMove, $x + 424,  $y + 231, 12, 12)
	...
	$g_grpVillageSW[8] 			= GUICtrlCreateGroup("Account 8", $x + 232, $y + 324, 209, 97, BitOR($GUI_SS_DEFAULT_GROUP,$BS_FLAT))
		...
		$g_icnPopOutSW[8] 		= GUICtrlCreateIcon($pIconLib, $eIcnMove, $x + 424,  $y + 333, 12, 12)
...
Func PopOut($Number = 1)
		Select
			Case $Number = 0
				Global $hGuiPopOut0 = GUICreate("", 220, 105, 0, $g_iMonitorY - 105 , BitOR($WS_SYSMENU, $WS_POPUP))
					GUISetBkColor($COLOR_WHITE, $hGuiPopOut0)
					GUISwitch($hGuiPopOut0)		
			
			Case $Number = 1
				Global $hGuiPopOut1 = GUICreate("", 220, 105, 0, $g_iMonitorY - 105 , BitOR($WS_SYSMENU, $WS_POPUP))
					GUISetBkColor($COLOR_WHITE, $hGuiPopOut1)
					GUISwitch($hGuiPopOut1)

			Case $Number = 2
				Global $hGuiPopOut2 = GUICreate("", 220, 105, 220, $g_iMonitorY - 105, BitOR($WS_SYSMENU, $WS_POPUP))
					GUISetBkColor($COLOR_WHITE, $hGuiPopOut2)
					GUISwitch($hGuiPopOut2)
					
			Case $Number = 3
				Global $hGuiPopOut3 = GUICreate("", 220, 105, 440, $g_iMonitorY - 105, BitOR($WS_SYSMENU, $WS_POPUP))
					GUISetBkColor($COLOR_WHITE, $hGuiPopOut3)
					GUISwitch($hGuiPopOut3)
					
			Case $Number = 4
				Global $hGuiPopOut4 = GUICreate("", 220, 105, 660, $g_iMonitorY - 105, BitOR($WS_SYSMENU, $WS_POPUP))
	...
	$g_grpVillagePO[$Number] 		= GUICtrlCreateGroup("Account 1", $x + 16, $y + 18, 209, 97, BitOR($GUI_SS_DEFAULT_GROUP,$BS_FLAT))
			...
			If $Number = 0 Then GUICtrlSetData(-1, GUICtrlRead($grpVillage))
		...
		$g_icnGoldPO[$Number] 		= GUICtrlCreateIcon($pIconLib, $eIcnGold, 	$x + 112, $y + 34, 18, 18)
		$g_icnElixirPO[$Number] 	= GUICtrlCreateIcon($pIconLib, $eIcnElixir, $x + 112, $y + 52, 18, 18)
		$g_icnDarkPO[$Number] 		= GUICtrlCreateIcon($pIconLib, $eIcnDark, 	$x + 112, $y + 70, 18, 18)
		...
		$g_icnGemPO[$Number] 			= GUICtrlCreateIcon($pIconLib, $eIcnGem, 		$x + 76,  $y + 90, 18, 18)
		$g_icnBuliderPO[$Number] 		= GUICtrlCreateIcon($pIconLib, $eIcnBuilder, 	$x + 126, $y + 90, 18, 18)
		$g_icnHourGlassPO[$Number] 	= GUICtrlCreateIcon($pIconLib, $eIcnHourGlass, 	$x + 204, $y + 90, 18, 18)
		...
		Select
			Case $Number = 0
				$g_icnPopOutEX[$Number] 	= GUICtrlCreateIcon($pIconLib, $eIcnDelete, 	$x + 208, $y + 27, 12, 12)
					GUICtrlSetOnEvent($g_icnPopOutEX[$Number],"PopOutEX0")
				WinSetTrans($hGuiPopOut0, "", 204)
				DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut0, "int", 500, "long", 0x00040008)
				GUISetState(@SW_SHOW)		
			Case $Number = 1
				$g_icnPopOutEX[$Number] 	= GUICtrlCreateIcon($pIconLib, $eIcnDelete, 	$x + 208, $y + 27, 12, 12)
					GUICtrlSetOnEvent($g_icnPopOutEX[$Number],"PopOutEX1")
				WinSetTrans($hGuiPopOut1, "", 204)
				DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut1, "int", 500, "long", 0x00040008)
				GUISetState(@SW_SHOW)
			Case $Number = 2
				$g_icnPopOutEX[$Number] 	= GUICtrlCreateIcon($pIconLib, $eIcnDelete, 	$x + 208, $y + 27, 12, 12)
					GUICtrlSetOnEvent($g_icnPopOutEX[$Number],"PopOutEX2")
				WinSetTrans($hGuiPopOut2, "", 204)	
				DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut2, "int", 500, "long", 0x00040008)
				GUISetState(@SW_SHOW)					
			Case $Number = 3
				$g_icnPopOutEX[$Number] 	= GUICtrlCreateIcon($pIconLib, $eIcnDelete, 	$x + 208, $y + 27, 12, 12)
					GUICtrlSetOnEvent($g_icnPopOutEX[$Number],"PopOutEX3")
				WinSetTrans($hGuiPopOut3, "", 204)	
				DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut3, "int", 500, "long", 0x00040008)
				GUISetState(@SW_SHOW)					
			Case $Number = 4
				$g_icnPopOutEX[$Number] 	= GUICtrlCreateIcon($pIconLib, $eIcnDelete, 	$x + 208, $y + 27, 12, 12)
					GUICtrlSetOnEvent($g_icnPopOutEX[$Number],"PopOutEX4")
				WinSetTrans($hGuiPopOut4, "", 204)	
				DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut4, "int", 500, "long", 0x00040008)
				GUISetState(@SW_SHOW)				
			Case $Number = 5
				$g_icnPopOutEX[$Number] 	= GUICtrlCreateIcon($pIconLib, $eIcnDelete, 	$x + 208, $y + 27, 12, 12)
					GUICtrlSetOnEvent($g_icnPopOutEX[$Number],"PopOutEX5")
				WinSetTrans($hGuiPopOut5, "", 204)	
				DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut5, "int", 500, "long", 0x00040008)
				GUISetState(@SW_SHOW)					
			Case $Number = 6
				$g_icnPopOutEX[$Number] 	= GUICtrlCreateIcon($pIconLib, $eIcnDelete, 	$x + 208, $y + 27, 12, 12)
					GUICtrlSetOnEvent($g_icnPopOutEX[$Number],"PopOutEX6")
				WinSetTrans($hGuiPopOut6, "", 204)	
				DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut6, "int", 500, "long", 0x00040008)
				GUISetState(@SW_SHOW)					
			Case $Number = 7
				$g_icnPopOutEX[$Number] 	= GUICtrlCreateIcon($pIconLib, $eIcnDelete, 	$x + 208, $y + 27, 12, 12)
					GUICtrlSetOnEvent($g_icnPopOutEX[$Number],"PopOutEX7")
				WinSetTrans($hGuiPopOut7, "", 204)	
				DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut7, "int", 500, "long", 0x00040008)
				GUISetState(@SW_SHOW)					
			Case $Number = 8
				$g_icnPopOutEX[$Number] 	= GUICtrlCreateIcon($pIconLib, $eIcnDelete, 	$x + 208, $y + 27, 12, 12)
					GUICtrlSetOnEvent($g_icnPopOutEX[$Number],"PopOutEX8")
				WinSetTrans($hGuiPopOut8, "", 204)
				DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut8, "int", 500, "long", 0x00040008)
				GUISetState(@SW_SHOW)					
		EndSelect
...
;============PopOut Exit Function==================
 Func PopOutEX0()
	DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut0, "int", 500, "long", 0x00050004)
	GUIDelete($hGuiPopOut0)
	GUICtrlSetState($g_icnPopOutSW[0], $GUI_ENABLE)
 EndFunc
 
 Func PopOutEX1()
	DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut1, "int", 500, "long", 0x00050004)
	GUIDelete($hGuiPopOut1)
	GUICtrlSetState($g_icnPopOutSW[1], $GUI_ENABLE)
 EndFunc
 
  Func PopOutEX2()
  	DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut2, "int", 500, "long", 0x00050004)
	GUIDelete($hGuiPopOut2)
	GUICtrlSetState($g_icnPopOutSW[2], $GUI_ENABLE)
 EndFunc
 
  Func PopOutEX3()
  	DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut3, "int", 500, "long", 0x00050004)
	GUIDelete($hGuiPopOut3)
	GUICtrlSetState($g_icnPopOutSW[3], $GUI_ENABLE)
 EndFunc
 
  Func PopOutEX4()
  	DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut4, "int", 500, "long", 0x00050004)
	GUIDelete($hGuiPopOut4)
	GUICtrlSetState($g_icnPopOutSW[4], $GUI_ENABLE)
 EndFunc
 
 Func PopOutEX5()
 	DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut5, "int", 500, "long", 0x00050004)
	GUIDelete($hGuiPopOut5)
	GUICtrlSetState($g_icnPopOutSW[5], $GUI_ENABLE)
 EndFunc
 
  Func PopOutEX6()
  	DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut6, "int", 500, "long", 0x00050004)
	GUIDelete($hGuiPopOut6)
	GUICtrlSetState($g_icnPopOutSW[6], $GUI_ENABLE)
 EndFunc
 
  Func PopOutEX7()
	DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut7, "int", 500, "long", 0x00050004)
	GUIDelete($hGuiPopOut7)
	GUICtrlSetState($g_icnPopOutSW[7], $GUI_ENABLE)
 EndFunc
 
  Func PopOutEX8()
	DllCall("user32.dll", "int", "AnimateWindow", "hwnd", $hGuiPopOut8, "int", 500, "long", 0x00050004)
